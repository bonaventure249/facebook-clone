            ...
            <div class="first-section">
                <div class="active-wrap top-pic-name-wrap   ">
                    <a href="profile.php" class="top-pic-name">
                        ...
                        <div class="top-name top-css" style="color:black;">Bonaventure</div>
                    </a>
                </div>
                <br>
            ...
            <div class="third-section">
                <div class="story-wrap">
                    ...
                    <a href="">
                        <div class="user-story">
                            ...
                            <div class="story-profile-wrap">
                                <div class="story-profile-name">Anton kaira</div>
                    ...
                    <a href="">
                        <div class="user-story">
                            ...
                            <div class="story-profile-wrap">
                                <div class="story-profile-name">Jonathan jondo</div>
                    ...
                    <a href="">
                        <div class="user-story">
                            ...
                            <div class="story-profile-wrap">
                                <div class="story-profile-name">Aron phiri</div>
                ...
                <div class="birthday-wrap">
                    <a href="" class="birthday-gift">
                        ...
                        <div class="birth-name-wrap"><span class="birth-name">karen miller</span><span class="birth-date">'s birthday today</span></div>
                    </a>
                </div>
                <div class="friend-request-wrap">
                    ...
                    <div class="friend-request-user">
                        ...
                        <div class="request-name-conf">
                            <div class="req-name">dongo boy</div>
                            <div class="req-conf">
                    ...
                    <div class="friend-request-user">
                        ...
                        <div class="request-name-conf">
                            <div class="req-name">kwangi hussein</div>
                            <div class="req-conf">
                                <div class="req-conf-yes">Confirm</div>
                                <div class="req-conf-del">Delete</div>
                            </div>
                    ...
                    <div class="friend-request-user">
                        ...
                        <div class="request-name-conf">
                            <div class="req-name">Benard mwewa</div>
                            <div class="req-conf">
                                <div class="req-conf-yes">Confirm</div>
                                <div class="req-conf-del">Delete</div>
                            </div>
